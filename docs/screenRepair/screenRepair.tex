...
\begin{titlepage}                       % Custom titlepage instead of the default \maketitle.
    ...
    {\huge \textbf{Icom IC-706 MkIIG \\ \vspace*{.5cm} Screen Polarizer Repair}}

    \vspace*{.5cm}                      % Subtitle
    \LARGE Written in \LaTeX\ by Joel M. Brigida
    ...
    \begin{minipage}{.5\textwidth}
        \centering
        Joel Brigida \\                 % Authors side by side, using two minipages as a trick.
