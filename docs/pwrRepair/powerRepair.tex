...
2 gray coax cables without damaging them. Figure XX shows the bottom cover removed. There are 5 screws to remove: 
3 in the middle and 2 on the side in the rear. 

\medskip
\begin{figure}[H]                       % Place image HERE.
    \centering                          % center the image.
    \includegraphics[width=0.9\textwidth]{../../img/bottomCover.jpg} % Need a picture of bottom panel removed.
    % highlight the coax
    \caption{Accessing the bottom of the bottom front PCB.} % Place caption BELOW image.
\end{figure}
...
\medskip
FILLER TEXT For this repair to be successful, the front board on the bottom side of the radio must be removed and and flipped
upside down. This is where the rubber pad and broken trace is located. The most care must be taken to unplug the 
2 gray coax cables without damaging them. Figure XX shows the bottom cover removed. There are 5 screws to remove: 
3 in the middle and 2 on the side in the rear. 
...
\begin{figure}[H]                       % Place image HERE.
    \centering                          % center the image.
    \includegraphics[width=0.9\textwidth]{../../img/bottomFrontPanel-removedFixed.jpg}
...
\begin{figure}[H]                       % Place image HERE.
    \centering                          % center the image.
    \includegraphics[width=0.9\textwidth]{../../img/corrodedPad.jpg} 
    \caption{Notice all the white dusty corrosion on the pad.} % Place caption BELOW image.
\end{figure}
...
\begin{figure}[H]                       % Place image HERE.
    \centering                          % center the image.
    \includegraphics[width=0.9\textwidth]{../../img/corrodedPad-closeUp.jpg} 
...
\begin{figure}[H]                       % Place image HERE.
    \centering                          % center the image.
    \includegraphics[width=0.9\textwidth]{../../img/corrodedTrace-labeled.jpg} 
    \caption{A damaged trace is revealed under the corrosion on the pad.} % Place caption BELOW image.
\end{figure}

In order to clean this corrosion to make the fix, one of these is needed:
\medskip
\begin{figure}[H]                       % Place image HERE.
    \centering                          % center the image.
    \includegraphics[width=0.9\textwidth]{../../img/scratchTool.jpg} 
    \caption{A damaged trace is revealed under the corrosion on the pad.} % Place caption BELOW image.
\end{figure}
...
\begin{figure}[H]                       % Place image HERE.
    \centering                          % center the image.
    \includegraphics[width=0.9\textwidth]{../../img/corrodedTrace-cleaned.jpg} 
    \caption{A damaged trace is revealed under the corrosion on the pad.} % Place caption BELOW image.
\end{figure}
...
\begin{figure}[H]                       % Place image HERE.
    \centering                          % center the image.
    \includegraphics[width=0.9\textwidth]{../../img/corrodedTrace-fixed.jpg} 
    \caption{A damaged trace is revealed under the corrosion on the pad.} % Place caption BELOW image.
\end{figure}
